...
class Game(tk.Frame):
	...
	def load_images(self):
		...
		self.rock1 = Image.open("rock-user.png")
		self.rock2 = Image.open("rock.png")
		self.scissors1 = Image.open("scissors-user (1).png")
		self.scissors2 = Image.open("scissors.png")
		self.paper1 = Image.open("paper.png")
		self.paper2 = Image.open("paper-user.png")
